...
print(red.Color+"═════════════════════════════════════════════════════════════════════")
print("")
hash_file = input(cyan.Color+"Enter the file to dencrypt it: ") 

def dencrypt_file(filename, key):
    with open(hash_file, "rb") as f:
        data = f.read()

    dencrypted_data = bytearray()
    for byte in data:
        dencrypted_data.append(byte ^ key)
